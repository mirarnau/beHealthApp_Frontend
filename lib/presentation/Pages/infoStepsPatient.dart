...
class InfoStepsPatientPage extends StatefulWidget {
  final Group group;
  const InfoStepsPatientPage({Key? key, required this.group}) : super(key: key);

  @override
  _InfoStepsPatientPageState createState() => _InfoStepsPatientPageState();
}

class _InfoStepsPatientPageState extends State<InfoStepsPatientPage> {
  ...
  Widget getMarkRange() {
    ...
    if (myUser.todayFootsteps < lowRangeValue) {
      print(myUser.todayFootsteps);
      return Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(
