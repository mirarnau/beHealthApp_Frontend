  ...
  Widget _buildForgotPasswordBtn() {
    return Container(
      ...
      child: FlatButton(
        ...
        child: Text(
          translate('pages.login_page.forgot_password'),
          style: kLabelStyle,
        ),
      ),
    );
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          ...
          Text(
            translate('pages.login_page.remember'),
            style: kLabelStyle,
          ),
        ],
      ),
  ...
  Widget _buildSignInWithText() {
    return Column(
      children: <Widget>[
        ...
        Text(
          translate('pages.login_page.sign_in_with'),
          style: kLabelStyle,
        ),
      ],
    );
    ...
    return GestureDetector(
      ...
      child: RichText(
        text: TextSpan(
          children: [
            TextSpan(
              text: translate('pages.login_page.no_account'),
              style: TextStyle(
                color: Colors.white,
                fontSize: 18.0,
                fontWeight: FontWeight.bold,
            ...
            TextSpan(
              text: translate('pages.login_page.sign_up'),
              style: TextStyle(
                color: Colors.white,
                fontSize: 18.0,
                fontWeight: FontWeight.bold,
